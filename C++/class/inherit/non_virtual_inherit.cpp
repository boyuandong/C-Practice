// This is an non-virtual inherit class
#include<iostream>
using namespace std;
// Base class B
class B
...
void test()
{
    D dd;                   // Constructor B, B1, B, B2, D
    dd.B1::b = 5;           // !!! Notice, b of B1, and b of B2 are different
    dd.B2::b = 10;          // There are two Bs when inherit, one for B1, one for B2
    dd.b1 = 25;
    dd.b2 = 100;
    dd.d = 140;
